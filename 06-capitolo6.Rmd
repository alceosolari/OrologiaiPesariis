# GLI OROLOGIAI SOLARI DI PESARIIS
...
```{r albero, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:albero)'}
knitr::include_graphics('immagini/solari.png')
```
...
```{r artigianato, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:artigianato)'}
knitr::include_graphics('immagini/artigianatoindustria.png')
```
...
```{r industria, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:industria)'}
knitr::include_graphics('immagini/nuoviorologi.png')
```
...
```{r lavorazioni, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:lavorazioni)'}
knitr::include_graphics('immagini/evoluzionetorni.png')
```
...
```{r fenditura, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:fenditura)'}
knitr::include_graphics('immagini/evoluzionefrese.png')
```
...
```{r commercio, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:commercio)'}
knitr::include_graphics('immagini/commerciosolari.png')
```
...
```{r municipio, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:municipio)'}
knitr::include_graphics('immagini/torrecherso.png')
```
...
```{r chiesa, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:chiesa)'}
knitr::include_graphics('immagini/torrepirano.png')
```
...
```{r orologiosp, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:orologiosp)'}
knitr::include_graphics('immagini/torrespalato.png')
```
...
```{r genealogia, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:genealogia)'}
knitr::include_graphics('immagini/solariart.png')
```
...
```{r macchina, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:macchina)'}
knitr::include_graphics('immagini/otpirano.png')
```
...
```{r logogiov, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:logogiov)'}
knitr::include_graphics('immagini/marchiogiovanni.png')
```
...
```{r faria, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:faria)'}
knitr::include_graphics('immagini/opificioidraulico.png')
```
...
```{r battista, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:battista)'}
knitr::include_graphics('immagini/giovannib.png')
```
...
Nella seconda metà del secolo XIX, i quattro fratelli della 6° generazione (10), Giacomo (1859), Antonio ( 1860) , Giovanni ( 1864) e Giuseppe ( ???) continuano a costruire orologi meccanici da torre con l’impiego dei macchinari azionati dall’ energia idraulica fornita dal mulino a pale. 
...
```{r tretreni, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:tretreni)'}
knitr::include_graphics('immagini/otbuie.png')
```
...
```{r quinta, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:quinta)'}
knitr::include_graphics('immagini/solariproto.png')
```
...
Fra i documenti conservati, presso la famiglia, c’è il dizionario italiano-serbo croato (edizione 1904) che dice l’esigenza di apprendere una nuova lingua per rendere più efficaci i rapporti commerciali con la Dalmazia. 
...
```{r ritratto, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:ritratto)'}
knitr::include_graphics('immagini/giovanni.png')
```
...
```{r casa, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:casa)'}
knitr::include_graphics('immagini/cjasuta.png')
```
...
```{r regolatore, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:regolatore)'}
knitr::include_graphics('immagini/biedermeier.png')
```
...
```{r sesta, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:sesta)'}
knitr::include_graphics('immagini/solariproto.png')
```
...
```{r atelier, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:atelier)'}
knitr::include_graphics('immagini/opificio1900.png')
```
...
```{r friuli, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:friuli)'}
knitr::include_graphics('immagini/udinetrieste.png')
```
...
```{r doppia, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:doppia)'}
knitr::include_graphics('immagini/pordenoneportogruaro.png')
```
...
```{r veneto, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:veneto)'}
knitr::include_graphics('immagini/chioggiacastelfranco.png')
```
...
```{r vemilia, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:vemilia)'}
knitr::include_graphics('immagini/ferrararovigo.png')
```
...
```{r sviluppo, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:sviluppo)'}
knitr::include_graphics('immagini/buiepisino.png')
```
...
```{r crescita, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:crescita)'}
knitr::include_graphics('immagini/zarasebenico.png')
```
...
(ref:stato) Referenze Solari Montenegro

```{r stato, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:stato)'}
knitr::include_graphics('immagini/montenegro.png')
```
...
```{r isola, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:isola)'}
knitr::include_graphics('immagini/greciacreta.png')
```
