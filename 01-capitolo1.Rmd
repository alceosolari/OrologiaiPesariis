...
```{r dondi, echo = F, fig.pos = 'H', out.width = '100%', out.height = '100%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:dondi)'}
knitr::include_graphics('immagini/1384astrario.png')
```
...
```{r leonardo, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:leonardo)'}
knitr::include_graphics('immagini/chiaravalle.jpeg')
``` 
...
```{r orologio, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:orologio)'}
knitr::include_graphics('immagini/precisione.jpeg')
```
