# LA TRANSIZIONE VERSO L'ELETTRONICA - dal 1961 al 1998



(ref:gianni) Nuovo marchio F.lli Solari spa

```{r gianni, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:gianni)'}
knitr::include_graphics('immagini/marchiogianni.png')
```
...
```{r ottava, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:ottava)'}
knitr::include_graphics('immagini/solariotto.png')
```
...
```{r timbratura, echo = F, fig.pos = 'H', out.width = '90%', out.height = '90%', fig.align = 'center', auto_pdf = TRUE, fig.cap='(ref:timbratura)'}
knitr::include_graphics('immagini/printac.png')
```
